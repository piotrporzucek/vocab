 ...
 */
public class SearchCoursePlace extends Place {

	/**
	 * Sample property (stores token).
	 */
	private final String name = "SearchCourse";
	 ...
	 */
	public static class Tokenizer implements PlaceTokenizer<SearchCoursePlace> {

		@Override
		public String getToken(SearchCoursePlace place) {
			return place.getName();
		}

		@Override
		public SearchCoursePlace getPlace(String token) {
			return new SearchCoursePlace();
		}
